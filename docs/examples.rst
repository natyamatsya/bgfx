...
tracing (direct lighting), progressive path tracing, path tracing with an SVGF denoiser
(temporal reprojection + variance-guided a-trous filtering), and ReSTIR DI. Uses hardware
